...
class MustacheTest extends TestCase
{
    ...
    public function testRenderFile()
    {
        ...
        $this->assertEquals('Gp Fabien', file_get_contents($this->dir.'/template.txt'), '::renderFile() renders a file');
    }
    ...
    public function testRenderDir()
    {
        ...
        $this->assertEquals('Gp Fabien', file_get_contents($this->dir.'/template.txt'), '::renderDir() renders a directory');
        $this->assertEquals('Gp Fabien', file_get_contents($this->dir.'/foo/bar.txt'), '::renderDir() renders a directory');
    }
}
