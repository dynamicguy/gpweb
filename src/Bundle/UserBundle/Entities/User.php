...
class User
{
    ...
    /**
     * Set gp_registrationID
     *
     * @param string $gpRegistrationID
     */
    public function setGpRegistrationID($gpRegistrationID)
    {
        $this->gp_registrationID = $gpRegistrationID;
    }

    /**
     * Get gp_registrationID
     *
     * @return string $gpRegistrationID
     */
    public function getGpRegistrationID()
    {
        return $this->gp_registrationID;
    }

    /**
     * Set gp_password
     *
     * @param string $gpPassword
     */
    public function setGpPassword($gpPassword)
    {
        $this->gp_password = $gpPassword;
    }

    /**
     * Get gp_password
     *
     * @return string $gpPassword
     */
    public function getGpPassword()
    {
     ...
     * Set gp_sourceMsisdn
     *
     * @param string $gpSourceMsisdn
     */
    public function setGpSourceMsisdn($gpSourceMsisdn)
    {
        $this->gp_sourceMsisdn = $gpSourceMsisdn;
    }

    /**
     * Get gp_sourceMsisdn
     *
     * @return string $gpSourceMsisdn
     */
    public function getGpSourceMsisdn()
    {
        return $this->gp_sourceMsisdn;
    }
