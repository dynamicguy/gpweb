...
check(is_writable(__DIR__.'/../gp/cache'), sprintf('Checking that cache/ directory is writable'), 'Change the permissions of the gp/cache/ directory so that the web server can write in it', true);
check(is_writable(__DIR__.'/../gp/logs'), sprintf('Checking that the logs/ directory is writable'), 'Change the permissions of the gp/logs/ directory so that the web server can write in it', true);
