...
use Application\GpBundle\GpBundle;
use Bundle\UserBundle\UserBundle;
use Bundle\SmsBundle\SmsBundle;
use Bundle\MmsBundle\MmsBundle;
use Bundle\LocatorBundle\LocatorBundle;
use Bundle\ChargeBundle\ChargeBundle;

class GpKernel extends Kernel
{
